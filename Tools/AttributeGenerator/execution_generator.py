...
# -*- coding: utf-8 -*-
"""
DJ01 GAS 代码生成器 - Execution 代码生成器
"""
...
class ExecutionCodeGenerator:
    ...
    def _generate_source(exe, class_name: str, timestamp: str) -> str:
        ...
        # 生成捕获结构体
        lines.extend(ExecutionCodeGenerator._generate_capture_struct(total_captures, base_captures))
        
        # 生成构造函数
        lines.extend(ExecutionCodeGenerator._generate_constructor(class_name, total_captures, base_captures))
        
        # 生成 Execute 函数
        lines.extend(ExecutionCodeGenerator._generate_execute(exe, class_name, total_captures, base_captures))
        
        return "\n".join(lines)
    
    @staticmethod
    def _generate_capture_struct(total_captures, base_captures) -> list:
        """生成属性捕获结构体"""
        lines = []
    ...
    @staticmethod
    def _generate_constructor(class_name, total_captures, base_captures) -> list:
        """生成构造函数"""
        lines = []
    ...
    @staticmethod
    def _generate_execute(exe, class_name, total_captures, base_captures) -> list:
        """生成 Execute_Implementation 函数"""
        lines = []
        ...
        return lines#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
DJ01 GAS 代码生成器 - Execution 代码生成器
"""
