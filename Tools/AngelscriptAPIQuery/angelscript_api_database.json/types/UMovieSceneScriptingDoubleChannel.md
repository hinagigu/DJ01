...
### AddKey
```angelscript
UMovieSceneScriptingDoubleKey AddKey(FFrameNumber InTime, float NewValue, float32 SubFrame, EMovieSceneTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation)
```
