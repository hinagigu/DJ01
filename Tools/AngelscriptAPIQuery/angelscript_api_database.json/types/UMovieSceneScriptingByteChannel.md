...
### AddKey
```angelscript
UMovieSceneScriptingByteKey AddKey(FFrameNumber InTime, uint8 NewValue, float32 SubFrame, EMovieSceneTimeUnit TimeUnit, EMovieSceneKeyInterpolation InInterpolation)
```
