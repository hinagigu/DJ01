...
### opAssign
```angelscript
FBlueprintFindSessionsResultDelegate& opAssign(FBlueprintFindSessionsResultDelegate Other)
```
...
### Broadcast
```angelscript
void Broadcast(const TArray<FBlueprintSessionResult>&in Results)
```
