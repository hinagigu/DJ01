...
### opAssign
```angelscript
FOnClusterUnionBoundsChanged& opAssign(FOnClusterUnionBoundsChanged Other)
```
...
### Broadcast
```angelscript
void Broadcast(UClusterUnionComponent Component, const FBoxSphereBounds&in Bounds)
```
