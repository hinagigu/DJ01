...
### opAssign
```angelscript
FWaitGameplayEffectRemovedDelegate& opAssign(FWaitGameplayEffectRemovedDelegate Other)
```
...
### Broadcast
```angelscript
void Broadcast(const FGameplayEffectRemovalInfo&in GameplayEffectRemovalInfo)
```
