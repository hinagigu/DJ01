...
### opAssign
```angelscript
FOnClusterUnionAddedComponent& opAssign(FOnClusterUnionAddedComponent Other)
```
...
### Broadcast
```angelscript
void Broadcast(UPrimitiveComponent Component, const TSet<int>&in BoneIds, bool bIsNew)
```
