...
- **描述**: Used for some analysis functions - specifies the bone/socket axis that points in the facing/forwards direction

### BoneRightAxis
- **类型**: `EAnalysisLinearAxis`
- **描述**: Used for some analysis functions - specifies the bone/socket axis that points to the "right"

### EulerCalculationMethod
- **类型**: `EEulerCalculationMethod`
- **描述**: Used for some analysis functions - specifies how yaw should be calculated from the bone axes
