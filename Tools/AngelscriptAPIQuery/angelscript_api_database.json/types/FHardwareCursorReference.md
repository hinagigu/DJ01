...
### CursorPath
- **类型**: `FName`
- **描述**: Specify the partial game content path to the hardware cursor.  For example,
...
### HotSpot
- **类型**: `FVector2D`
- **描述**: HotSpot needs to be in normalized (0..1) coordinates since it may apply to different resolution images.
