...
#include "DJ01/Experience/Public/AsyncAction_ExperienceReady.h"
...
void UAsyncAction_ExperienceReady::Step2_ListenToExperienceLoading(AGameStateBase* GameState)
{
	...
	{
		ExperienceComponent->CallOrRegister_OnExperienceLoaded(FOnDJ01ExperienceLoaded::FDelegate::CreateUObject(this, &ThisClass::Step3_HandleExperienceLoaded));
	}
}

void UAsyncAction_ExperienceReady::Step3_HandleExperienceLoaded(const UDJ01ExperienceDefinition* CurrentExperience)
{
