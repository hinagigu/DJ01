...
#include UE_INLINE_GENERATED_CPP_BY_NAME(DJ01ExperienceDefinition)

#define LOCTEXT_NAMESPACE "DJ01System"

UDJ01ExperienceDefinition::UDJ01ExperienceDefinition()
{
}

#if WITH_EDITOR
EDataValidationResult UDJ01ExperienceDefinition::IsDataValid(FDataValidationContext& Context) const
{
...
void UDJ01ExperienceDefinition::UpdateAssetBundleData()
{
