...
#include "DJ01UserFacingExperienceDefinition.generated.h"
...
class UDJ01UserFacingExperienceDefinition : public UPrimaryDataAsset
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category=Experience, meta=(AllowedTypes="DJ01ExperienceDefinition"))
