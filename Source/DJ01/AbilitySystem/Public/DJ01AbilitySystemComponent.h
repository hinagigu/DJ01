...
DJ01_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_AbilityInputBlocked);
...
public:
	...
	UDJ01AbilitySystemComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	...
	typedef TFunctionRef<bool(const UDJ01GameplayAbility* DJ01Ability, FGameplayAbilitySpecHandle Handle)> TShouldCancelAbilityFunc;
