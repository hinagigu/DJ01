...
#include "DJ01AbilityTagRelationshipMapping.generated.h"
...
UCLASS()
class UDJ01AbilityTagRelationshipMapping : public UDataAsset
{
	GENERATED_BODY()
...
private:
	...
	TArray<FDJ01AbilityTagRelationship> AbilityTagRelationships;
