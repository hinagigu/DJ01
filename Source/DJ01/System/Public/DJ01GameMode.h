...
#include "DJ01GameMode.generated.h"
...
*/
DECLARE_MULTICAST_DELEGATE_TwoParams(FOnDJ01GameModePlayerInitialized, AGameModeBase* /*GameMode*/, AController* /*NewPlayer*/);
...
class DJ01_API ADJ01GameMode : public AModularGameModeBase
{
	GENERATED_BODY()

public:

	ADJ01GameMode(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UFUNCTION(BlueprintCallable, Category = "DJ01|Pawn")
	const UDJ01PawnData* GetPawnDataForController(const AController* InController) const;
	...
	FOnDJ01GameModePlayerInitialized OnGameModePlayerInitialized;
