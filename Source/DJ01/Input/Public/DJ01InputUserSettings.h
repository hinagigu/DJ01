...
#include "DJ01InputUserSettings.generated.h"

/** 
* Custom settings class for any input related settings for the DJ01 game.
* This will be serialized out at the same time as the DJ01 Shared Settings and is
* compatible with cloud saves through by calling the "Serialize" function.
*/
UCLASS()
class DJ01_API UDJ01InputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS()
class DJ01_API UDJ01PlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
