...
#include "DJ01CheatManager.generated.h"

// class UDJ01AbilitySystemComponent; // TODO: AbilitySystem
...
DECLARE_LOG_CATEGORY_EXTERN(LogDJ01Cheat, Log, All);
...
class UDJ01CheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	// void ApplySetByCallerDamage(ULyraAbilitySystemComponent* LyraASC, float DamageAmount); // TODO: AbilitySystem
	// void ApplySetByCallerHeal(ULyraAbilitySystemComponent* LyraASC, float HealAmount); // TODO: AbilitySystem

	// ULyraAbilitySystemComponent* GetPlayerAbilitySystemComponent() const; // TODO: AbilitySystem
};
