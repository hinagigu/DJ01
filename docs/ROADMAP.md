...
| 基础敌人 AI | ⬜ 待开始 | P0 | 行为树 + 繁殖魔物行为模式 |
| 角色移动完善 | ⬜ 待开始 | P1 | 闪避、冲刺等动作 |
| 五系魔法原型 | ⬜ 待开始 | P1 | 至少实现 2 个系的基础技能 |
...
|------|------|----------|
| 文档分散 | 查找困难 | 本路标文档作为索引 |
| Lyra 参考代码 (.txt) | 需要对照学习 | 逐步替换为自己实现 |
| 缺少完整战斗循环 | 无法验证设计 | Phase 1 优先完成 |
...
### 本周目标
1. [ ] 完成基础近战攻击 GameplayAbility
2. [x] ~~实现 DJ01DamageExecution 伤害计算~~ ✅ 已完成
3. [ ] 创建测试用敌人 Pawn
4. [ ] 创建基础伤害 GameplayEffect 测试伤害流程

### 待解决问题
- 如何设计"繁殖魔物"的行为模式 (可预测但有威胁)
- 五系魔法的技能树结构
- 社会系统的数据结构设计
